...
public class ShadowModeEvent extends BaseEvent {
    ...
    @Override public int getWeight() { return 45; }
    @Override public int getDurationTicks() { return 600; }

    @Override
    public void execute(EventContext context) {
        context.player().addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, 600, 0));
        EventNotifyUtil.notifyPlayer(context.player(), this, "Невидимість на 30 сек");
    }
}